...
INSERT INTO bo_phan VALUES(1,'Sale-Maketing'),
						  (2,'Hanh Chinh'),
                          (3,'Phục Vụ'),
                          (4,'Quản Lý');
CREATE TABLE nhan_vien (
    ...
    luong DOUBLE NOT NULL CHECK(luong > 0),
...
CREATE TABLE dich_vu (
    ...
    chi_phi_thue DOUBLE NOT NULL CHECK (chi_phi_thue >0),
    so_nguoi_toi_da INT CHECK (so_nguoi_toi_da >0),
    tieu_chuan_phong VARCHAR(45),
    mo_ta_tien_nghi_khac VARCHAR(45),
    dien_tich_ho_boi DOUBLE DEFAULT 0 CHECK (dien_tich_ho_boi >= 0),
    so_tang INT,
...
-- DROP TABLE hop_dong;
-- CHECK(ROUND(DATEDIFF(ngay_ket_thuc, ngay_bat_dau)) >= 0)
