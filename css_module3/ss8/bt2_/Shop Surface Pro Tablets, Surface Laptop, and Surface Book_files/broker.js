...
}}if(/graceperiod|lastinvited|state|surveys|trackertimestamp|userid|vendorid|sv|name|timestamp|url|^\d$/.test(G)){
...
C.executingPath=A.getExecutingPath("broker.js");if(/cs\_tstMode/i.test(window.location)){A.loadScript("https://www.microsoft.com/library/svy/"+C.testUrl,true);
